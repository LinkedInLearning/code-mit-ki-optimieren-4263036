...
class Database:
    ...
    def initialize(self):
        try:
            ...
            return f"Fehler beim Initialisieren der Datenbank: {e}"
    ...
    def read(self):
        try:
            ...
            return f"Fehler beim Lesen aus der Datenbank: {e}"
    ...
    def write(self, n, v):
        try:
            if os.path.exists(self.db_file):
                ...
                connection.commit()
                connection.close()
                return f"Daten geschrieben: {n}, {v}"
            else:
                return "Datenbank nicht vorhanden"
        except sqlite3.Error as e:
            return f"Fehler beim Schreiben in die Datenbank: {e}"
...
class Application(tk.Frame):
    ...
    def initialize_db(self):
        try:
            ...
            self.status['text'] = f"Fehler beim Initialisieren der Datenbank: {e}"
    ...
    def update_display(self):
        try:
            ...
            messagebox.showerror('Fehler beim Lesen der Daten', f'Fehler: {e}')
    ...
    def handle_entry(self):
        try:
            ...
            messagebox.showerror('Fehler beim Speichern', f'Fehler: {e}')
...
if __name__ == "__main__":
    try:
        ...
        messagebox.showerror('Fehler beim Starten der Anwendung', f'Fehler: {e}')
